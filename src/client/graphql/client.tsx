 ...
 * });
 */
export function useGetTopPageQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<GetTopPageQuery, GetTopPageQueryVariables>) {
        return ApolloReactHooks.useQuery<GetTopPageQuery, GetTopPageQueryVariables>(GetTopPageDocument, baseOptions);
      }
export function useGetTopPageLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetTopPageQuery, GetTopPageQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<GetTopPageQuery, GetTopPageQueryVariables>(GetTopPageDocument, baseOptions);
        }
...
export type GetTopPageQueryResult = ApolloReactCommon.QueryResult<GetTopPageQuery, GetTopPageQueryVariables>;